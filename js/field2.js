(function (window, $) {
	...
	function setup() {
	        ...
	        lives = 50;
	        words = ["тюлень", "геноцид"];
					tasks = ["Талисманом московской Олимпиады 1980-го годда стал Олимпийский Мишка. Частью олимпиады были соревнования яхтсменов, проходившие в Таллине. Это животное было талисманом этих соревнований." ,
					 "Страна, принимавшая Олимпиаду 1936-го года, параллельно была частью другого международного движения."
					 ]
	        messages = {
	            win: 'You win!',
	            lose: 'Game over!',
